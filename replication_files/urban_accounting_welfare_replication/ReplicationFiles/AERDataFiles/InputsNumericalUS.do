* This program generates the inputs needed to run the counterfactual exercise for the U.S. in "Urban Accounting and Welfare" by Klaus Desmet and Esteban Rossi-Hansberg
* October 11, 2012
...
log using InputsNumericalUS.log, replace
